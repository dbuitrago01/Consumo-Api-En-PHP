...
document.getElementById('mi-formulario').addEventListener('submit', async function(event) {
    ...
    try {
      // Se realiza la petición POST al endpoint api.php para insertar las ventas
      ...
      // Obtener el input donde se mostrará el total de descuentos en el formulario.
       const totalDescuentosInput = document.querySelector('#totalDescuentos');

    // Se Hacer una petición GET al endpoint descuentos.php para obtener el total de descuentos.
